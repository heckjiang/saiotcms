...
public class QSite extends EntityPathBase<Site> {
    ...
    public final ListPath<com.saiot.cms.core.domain.Role, QRole> roles = this.<com.saiot.cms.core.domain.Role, QRole>createList("roles", com.saiot.cms.core.domain.Role.class, QRole.class, PathInits.DIRECT2);
