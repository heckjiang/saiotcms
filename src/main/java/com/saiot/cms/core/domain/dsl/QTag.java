...
public class QTag extends EntityPathBase<Tag> {
    ...
    public final SetPath<com.saiot.cms.core.domain.InfoTag, QInfoTag> infoTags = this.<com.saiot.cms.core.domain.InfoTag, QInfoTag>createSet("infoTags", com.saiot.cms.core.domain.InfoTag.class, QInfoTag.class, PathInits.DIRECT2);
