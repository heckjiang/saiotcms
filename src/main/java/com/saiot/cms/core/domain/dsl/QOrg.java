...
public class QOrg extends EntityPathBase<Org> {
    ...
    public final SetPath<com.saiot.cms.core.domain.UserOrg, QUserOrg> userOrgs = this.<com.saiot.cms.core.domain.UserOrg, QUserOrg>createSet("userOrgs", com.saiot.cms.core.domain.UserOrg.class, QUserOrg.class, PathInits.DIRECT2);

    public final SetPath<com.saiot.cms.core.domain.User, QUser> users = this.<com.saiot.cms.core.domain.User, QUser>createSet("users", com.saiot.cms.core.domain.User.class, QUser.class, PathInits.DIRECT2);
