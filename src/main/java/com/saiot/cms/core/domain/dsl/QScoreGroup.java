...
public class QScoreGroup extends EntityPathBase<ScoreGroup> {
    ...
    public final ListPath<com.saiot.cms.core.domain.ScoreItem, QScoreItem> items = this.<com.saiot.cms.core.domain.ScoreItem, QScoreItem>createList("items", com.saiot.cms.core.domain.ScoreItem.class, QScoreItem.class, PathInits.DIRECT2);
