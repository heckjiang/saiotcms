...
public class QQuestion extends EntityPathBase<Question> {
    ...
    public final ListPath<com.saiot.cms.ext.domain.QuestionItem, QQuestionItem> items = this.<com.saiot.cms.ext.domain.QuestionItem, QQuestionItem>createList("items", com.saiot.cms.ext.domain.QuestionItem.class, QQuestionItem.class, PathInits.DIRECT2);

    public final NumberPath<Integer> mode = createNumber("mode", Integer.class);

    public final SetPath<com.saiot.cms.ext.domain.QuestionRecord, QQuestionRecord> records = this.<com.saiot.cms.ext.domain.QuestionRecord, QQuestionRecord>createSet("records", com.saiot.cms.ext.domain.QuestionRecord.class, QQuestionRecord.class, PathInits.DIRECT2);
