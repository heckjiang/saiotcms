...
public class QUser extends EntityPathBase<User> {
    ...
    public final SetPath<com.saiot.cms.core.domain.UserDetail, QUserDetail> details = this.<com.saiot.cms.core.domain.UserDetail, QUserDetail>createSet("details", com.saiot.cms.core.domain.UserDetail.class, QUserDetail.class, PathInits.DIRECT2);
    ...
    public final ListPath<com.saiot.cms.core.domain.UserMemberGroup, QUserMemberGroup> userGroups = this.<com.saiot.cms.core.domain.UserMemberGroup, QUserMemberGroup>createList("userGroups", com.saiot.cms.core.domain.UserMemberGroup.class, QUserMemberGroup.class, PathInits.DIRECT2);

    public final StringPath username = createString("username");

    public final ListPath<com.saiot.cms.core.domain.UserOrg, QUserOrg> userOrgs = this.<com.saiot.cms.core.domain.UserOrg, QUserOrg>createList("userOrgs", com.saiot.cms.core.domain.UserOrg.class, QUserOrg.class, PathInits.DIRECT2);

    public final ListPath<com.saiot.cms.core.domain.UserRole, QUserRole> userRoles = this.<com.saiot.cms.core.domain.UserRole, QUserRole>createList("userRoles", com.saiot.cms.core.domain.UserRole.class, QUserRole.class, PathInits.DIRECT2);
