...
public class QGuestbook extends EntityPathBase<Guestbook> {
    ...
    public final com.saiot.cms.core.domain.dsl.QUser creator;
    ...
    public final com.saiot.cms.core.domain.dsl.QUser replyer;
    ...
    public QGuestbook(Class<? extends Guestbook> type, PathMetadata metadata, PathInits inits) {
        ...
        this.creator = inits.isInitialized("creator") ? new com.saiot.cms.core.domain.dsl.QUser(forProperty("creator"), inits.get("creator")) : null;
        this.replyer = inits.isInitialized("replyer") ? new com.saiot.cms.core.domain.dsl.QUser(forProperty("replyer"), inits.get("replyer")) : null;
