...
public class QWorkflowProcess extends EntityPathBase<WorkflowProcess> {
    ...
    public final SetPath<com.saiot.cms.core.domain.WorkflowLog, QWorkflowLog> logs = this.<com.saiot.cms.core.domain.WorkflowLog, QWorkflowLog>createSet("logs", com.saiot.cms.core.domain.WorkflowLog.class, QWorkflowLog.class, PathInits.DIRECT2);
