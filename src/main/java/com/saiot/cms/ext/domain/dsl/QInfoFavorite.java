...
public class QInfoFavorite extends EntityPathBase<InfoFavorite> {
    ...
    public final com.saiot.cms.core.domain.dsl.QInfo info;
    ...
    public QInfoFavorite(Class<? extends InfoFavorite> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = _super.id;
        this.info = inits.isInitialized("info") ? new com.saiot.cms.core.domain.dsl.QInfo(forProperty("info"), inits.get("info")) : null;
