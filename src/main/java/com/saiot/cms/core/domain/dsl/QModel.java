...
public class QModel extends EntityPathBase<Model> {
    ...
    public final ListPath<com.saiot.cms.core.domain.ModelField, QModelField> fields = this.<com.saiot.cms.core.domain.ModelField, QModelField>createList("fields", com.saiot.cms.core.domain.ModelField.class, QModelField.class, PathInits.DIRECT2);
