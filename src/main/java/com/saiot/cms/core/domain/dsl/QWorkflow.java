...
public class QWorkflow extends EntityPathBase<Workflow> {
    ...
    public final ListPath<com.saiot.cms.core.domain.WorkflowStep, QWorkflowStep> steps = this.<com.saiot.cms.core.domain.WorkflowStep, QWorkflowStep>createList("steps", com.saiot.cms.core.domain.WorkflowStep.class, QWorkflowStep.class, PathInits.DIRECT2);
