...
import com.saiot.cms.ext.domain.Collect;
...
public class QCollect extends EntityPathBase<Collect> {
    ...
    public final ListPath<com.saiot.cms.ext.domain.CollectField, QCollectField> fields = this.<com.saiot.cms.ext.domain.CollectField, QCollectField>createList("fields", com.saiot.cms.ext.domain.CollectField.class, QCollectField.class, PathInits.DIRECT2);
    ...
    public final com.saiot.cms.core.domain.dsl.QNode node;
    ...
    public final com.saiot.cms.core.domain.dsl.QUser user;
    ...
    public QCollect(Class<? extends Collect> type, PathMetadata metadata, PathInits inits) {
        ...
        this.node = inits.isInitialized("node") ? new com.saiot.cms.core.domain.dsl.QNode(forProperty("node"), inits.get("node")) : null;
        this.site = inits.isInitialized("site") ? new com.saiot.cms.core.domain.dsl.QSite(forProperty("site"), inits.get("site")) : null;
        this.user = inits.isInitialized("user") ? new com.saiot.cms.core.domain.dsl.QUser(forProperty("user"), inits.get("user")) : null;
    }
