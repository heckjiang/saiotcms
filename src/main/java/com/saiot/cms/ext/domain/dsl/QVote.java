...
public class QVote extends EntityPathBase<Vote> {
    ...
    public final ListPath<com.saiot.cms.ext.domain.VoteOption, QVoteOption> options = this.<com.saiot.cms.ext.domain.VoteOption, QVoteOption>createList("options", com.saiot.cms.ext.domain.VoteOption.class, QVoteOption.class, PathInits.DIRECT2);
