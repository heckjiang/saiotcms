...
public class QQuestionRecord extends EntityPathBase<QuestionRecord> {
    ...
    public final SetPath<com.saiot.cms.ext.domain.QuestionOptRec, QQuestionOptRec> optRecs = this.<com.saiot.cms.ext.domain.QuestionOptRec, QQuestionOptRec>createSet("optRecs", com.saiot.cms.ext.domain.QuestionOptRec.class, QQuestionOptRec.class, PathInits.DIRECT2);
