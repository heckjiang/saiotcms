...
public class QAttachment extends EntityPathBase<Attachment> {
    ...
    public final SetPath<com.saiot.cms.core.domain.AttachmentRef, QAttachmentRef> refs = this.<com.saiot.cms.core.domain.AttachmentRef, QAttachmentRef>createSet("refs", com.saiot.cms.core.domain.AttachmentRef.class, QAttachmentRef.class, PathInits.DIRECT2);
