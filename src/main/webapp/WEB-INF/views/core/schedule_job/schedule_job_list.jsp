...
<div class="content-header">
	<h1><s:message code="scheduleJob.management"/> - <s:message code="list"/> <small>(<s:message code="totalElements" arguments="${fn:length(list)}"/>)</small></h1>
</div>
		...
		<div class="box-body table-responsive">
			<form action="list.do" method="get" class="form-inline ls-search">
				<div class="form-group">
				  <label for="search_CONTAIN_name"><s:message code="scheduleJob.name"/></label>
				  <input class="form-control input-sm" type="text" id="search_CONTAIN_name" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}" style="width:150px;"/>
				</div>
				<div class="form-group">
				  <label for="search_CONTAIN_code"><s:message code="scheduleJob.code"/></label>
		      <select class="form-control input-sm" name="search_CONTAIN_code">
