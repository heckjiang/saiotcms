...
public class QNode extends EntityPathBase<Node> {
    ...
    public final SetPath<com.saiot.cms.core.domain.NodeBuffer, QNodeBuffer> buffers = this.<com.saiot.cms.core.domain.NodeBuffer, QNodeBuffer>createSet("buffers", com.saiot.cms.core.domain.NodeBuffer.class, QNodeBuffer.class, PathInits.DIRECT2);
    ...
    public final SetPath<com.saiot.cms.core.domain.NodeDetail, QNodeDetail> details = this.<com.saiot.cms.core.domain.NodeDetail, QNodeDetail>createSet("details", com.saiot.cms.core.domain.NodeDetail.class, QNodeDetail.class, PathInits.DIRECT2);
    ...
    public final SetPath<com.saiot.cms.core.domain.NodeMemberGroup, QNodeMemberGroup> nodeGroups = this.<com.saiot.cms.core.domain.NodeMemberGroup, QNodeMemberGroup>createSet("nodeGroups", com.saiot.cms.core.domain.NodeMemberGroup.class, QNodeMemberGroup.class, PathInits.DIRECT2);

    public final QModel nodeModel;

    public final SetPath<com.saiot.cms.core.domain.NodeOrg, QNodeOrg> nodeOrgs = this.<com.saiot.cms.core.domain.NodeOrg, QNodeOrg>createSet("nodeOrgs", com.saiot.cms.core.domain.NodeOrg.class, QNodeOrg.class, PathInits.DIRECT2);

    public final SetPath<com.saiot.cms.core.domain.NodeRole, QNodeRole> nodeRoles = this.<com.saiot.cms.core.domain.NodeRole, QNodeRole>createSet("nodeRoles", com.saiot.cms.core.domain.NodeRole.class, QNodeRole.class, PathInits.DIRECT2);
