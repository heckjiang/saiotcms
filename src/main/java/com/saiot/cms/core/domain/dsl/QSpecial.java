...
public class QSpecial extends EntityPathBase<Special> {
    ...
    public final ListPath<com.saiot.cms.core.domain.SpecialFile, QSpecialFile> files = this.<com.saiot.cms.core.domain.SpecialFile, QSpecialFile>createList("files", com.saiot.cms.core.domain.SpecialFile.class, QSpecialFile.class, PathInits.DIRECT2);

    public final NumberPath<Integer> id = createNumber("id", Integer.class);

    public final ListPath<com.saiot.cms.core.domain.SpecialImage, QSpecialImage> images = this.<com.saiot.cms.core.domain.SpecialImage, QSpecialImage>createList("images", com.saiot.cms.core.domain.SpecialImage.class, QSpecialImage.class, PathInits.DIRECT2);
