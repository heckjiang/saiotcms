...
<%@ taglib prefix="f" uri="http://www.hksaiot.com/tags/form" %>
...
<body class="hold-transition login-page" style="background-color:#2d3a4b;">
<%
	String defUsername = com.saiot.cms.core.constant.Constants.DEF_USERNAME;
    String defPassword = com.saiot.cms.core.constant.Constants.DEF_PASSWORD;
...
<div class="login-box">
	<div class="login-img">
       	<img alt="Saiotcms" src="/static/img/log.png" style="padding-left: 100px;">
    </div>
    <div class="login-logo">
        <a href="${ctx}/" style="color:#fff;"><b>Saiot</b>CMS</a>
    </div>
    <div class="login-box-body">
        <p class="login-box-msg text-danger">
            <c:if test="${!empty shiroLoginFailure}">
                ...
                <c:choose>
                    <c:when test="${shiroLoginFailure=='com.saiot.cms.common.security.IncorrectCaptchaException'}">
                        <s:message code='incorrectCaptchaError'/>
                    </c:when>
                    <c:when test="${shiroLoginFailure=='com.saiot.cms.common.security.CaptchaRequiredException'}">
