...
public class QGlobal extends EntityPathBase<Global> {
    ...
    public final ListPath<com.saiot.cms.core.domain.Site, QSite> sites = this.<com.saiot.cms.core.domain.Site, QSite>createList("sites", com.saiot.cms.core.domain.Site.class, QSite.class, PathInits.DIRECT2);
