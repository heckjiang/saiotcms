...
public class Constants {
	 ...
	 * 身份识别COOKIE名称
	 */
	public static final String IDENTITY_COOKIE_NAME = "_saiotcms";
	/**
	 * 默认分页数量
	 */
	 ...
	 * 
	 * 模版路径在应用外，以file:开头。可以实现程序与模版分开部署（配合上传文件发布点和全文索引位置fsDirectory.location）。 如：file:d:\\saiotcms\\template 或
