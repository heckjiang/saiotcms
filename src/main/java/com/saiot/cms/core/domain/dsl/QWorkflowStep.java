...
public class QWorkflowStep extends EntityPathBase<WorkflowStep> {
    ...
    public final ListPath<com.saiot.cms.core.domain.WorkflowStepRole, QWorkflowStepRole> stepRoles = this.<com.saiot.cms.core.domain.WorkflowStepRole, QWorkflowStepRole>createList("stepRoles", com.saiot.cms.core.domain.WorkflowStepRole.class, QWorkflowStepRole.class, PathInits.DIRECT2);
