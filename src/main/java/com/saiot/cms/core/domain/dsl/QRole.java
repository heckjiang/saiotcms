...
public class QRole extends EntityPathBase<Role> {
    ...
    public final SetPath<com.saiot.cms.core.domain.UserRole, QUserRole> userRoles = this.<com.saiot.cms.core.domain.UserRole, QUserRole>createSet("userRoles", com.saiot.cms.core.domain.UserRole.class, QUserRole.class, PathInits.DIRECT2);
